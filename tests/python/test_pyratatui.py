...
class TestBarGraph:
    ...
    def test_style_variants(self):
        ...
        assert BarGraph([0.5]).bar_style(BarGraphStyle.Solid) is not None
        assert BarGraph([0.5]).bar_style(BarGraphStyle.Quadrant) is not None
...
class TestVersion:
    def test_version_present(self):
        ...
        assert pyratatui.__version__ == "0.2.5"
...
class TestBarGraphWidget:
    """Test BarGraph widget."""

    def test_bar_graph_creation(self):
        """Test creating a bar graph."""
        from pyratatui import BarGraph

        data = [0.1, 0.5, 0.3, 0.9, 0.7]
        graph = BarGraph(data)
        assert graph.len == 5

    def test_bar_graph_with_style(self):
        """Test bar graph with style."""
        from pyratatui import BarGraph, BarGraphStyle

        graph = BarGraph([0.5, 0.7]).bar_style(BarGraphStyle.Braille)
        assert graph is not None

    def test_bar_graph_with_color_mode(self):
        """Test bar graph with color mode."""
        from pyratatui import BarColorMode, BarGraph

        graph = BarGraph([0.5]).color_mode(BarColorMode.VerticalGradient)
        assert graph is not None
...
class TestTreeWidget:
    ...
    def test_tree_item_creation(self):
        """Test creating tree items."""
        from pyratatui import TreeItem

        item = TreeItem("Root")
        assert item.text == "Root"

    def test_tree_item_with_children(self):
        """Test tree item with children."""
        from pyratatui import TreeItem
...
class TestCanvasWidget:
    ...
    def test_canvas_draw_point(self):
    ...
    def test_canvas_draw_line(self):
        """Test drawing a line."""
        from pyratatui import Canvas
    ...
    def test_canvas_draw_rect(self):
...
class TestButtonWidget:
    ...
    def test_button_creation(self):
        ...
        from pyratatui import Button

        btn = Button("Click me")
        assert btn.label == "Click me"

    def test_button_focus(self):
        ...
        unfocused = focused.unfocus()
        assert not unfocused.is_focused()

    def test_button_label_change(self):
        """Test changing button label."""
        from pyratatui import Button
